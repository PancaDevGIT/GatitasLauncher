 ...
 * @author PancaDev
 */
const clientId = '1095809287357472848';
 ...
 async function setActivity() {
    if (!RPC) return;
    RPC.setActivity({
        details: `Gatitas Legacy Server`,
        state: `Jugando 🐱 | 0/0 jugadores`,
        startTimestamp: Date.now(),
        largeImageKey: 'gatitasicon',
        largeImageText: 'Gatitas Legacy',
        instance: false,
        buttons: [
            {
                label: '⭐ Discord Server',
                url: 'https://discord.gg/Y6SuSuNajn',
            },

            {
                label: '💲 Ko-fi (Donaciones)',
                url: 'https://ko-fi.com/gatitaslegacymc',
            }
        ]
    });
}
